...
var defaultTrustedProxyCIDRs = []string{
	...
	"192.168.0.0/16",
	"fc00::/7",
	// Cloudflare publishes these networks at https://www.cloudflare.com/ips/.
	"173.245.48.0/20",
	"103.21.244.0/22",
	"103.22.200.0/22",
	"103.31.4.0/22",
...
func configureTrustedProxies(engine *gin.Engine) error {
	...
	if rawTrustedProxies == "" {
		log.Print("WARNING: TRUSTED_PROXIES is unset or blank; trusting loopback, RFC 1918, IPv6 ULA, and Cloudflare proxy addresses for compatibility. Set TRUSTED_PROXIES=none to trust no proxies, or configure explicit proxy IPs/CIDRs to replace these defaults.")

...
func TestGeminiResponsesHandlerReturnsOpenAIResponsesJSON(t *testing.T) {
	...
	usage, nbapiError := GeminiResponsesHandler(c, info, &http.Response{
		Body: io.NopCloser(bytes.NewReader(body)),
	})
	require.Nil(t, nbapiError)
...
func TestGeminiResponsesHandlerClosesBodyOnReadError(t *testing.T) {
	...
	usage, nbapiError := GeminiResponsesHandler(c, newGeminiResponsesRelayInfo(false), &http.Response{Body: body})
...
func TestGeminiResponsesStreamHandlerReturnsOpenAIResponsesSSE(t *testing.T) {
	...
	usage, nbapiError := GeminiResponsesStreamHandler(c, info, &http.Response{

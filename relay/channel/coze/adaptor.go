...
import (
	...
	"github.com/Lorry-San/nbapi/relay/common"
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *common.RelayInfo) (usage any, err *types.NBAPIError) {
	if info.IsStream {

...
func ClaudeHelper(c *gin.Context, info *relaycommon.RelayInfo) (nbapiError *types.NBAPIError) {
	...
	if !model_setting.GetGlobalSettings().PassThroughRequestEnabled &&
		...
		usage, nbapiErr := chatCompletionsViaResponses(c, info, adaptor, openAIRequest)
		if nbapiErr != nil {
			return nbapiErr
		}

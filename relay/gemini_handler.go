...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (nbapiError *types.NBAPIError) {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (nbapiError *types.NBAPIError) {
	info.InitChannelMeta(c)

...
export function ChannelMutateDrawer({
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      toast.warning(
        t(
          'Warning: Base URL should not end with /v1. NBAPI will handle it automatically. This may cause request failures.'
        ),
        { duration: 5000 }
      )
    }, 500)
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem className='flex items-center justify-between px-4 py-3'>
                                    <div className='space-y-0.5'>
                                      <FormLabel>
                                        {t('Responses to ChatCompletions')}
                                      </FormLabel>
                                      <FormDescription>
                                        {t(
                                          'Force /v1/responses requests on this channel to use /v1/chat/completions upstream'
                                        )}
                                      </FormDescription>
                                    </div>
                                    <FormControl>

...
func GetOpsAlertMetricsMetadata() []OpsAlertMetricsMetadata {
	return []OpsAlertMetricsMetadata{
		...
		{Key: OpsAlertMetricAvgTTFTMs, Label: "平均首 Token 延迟", Unit: "ms", Comparator: OpsAlertComparatorGT},
		{Key: OpsAlertMetricP95TTFTMs, Label: "P95 首 Token 延迟", Unit: "ms", Comparator: OpsAlertComparatorGT},
		{Key: OpsAlertMetricP99TTFTMs, Label: "P99 首 Token 延迟", Unit: "ms", Comparator: OpsAlertComparatorGT},

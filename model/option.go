...
import (
	...
	"github.com/Lorry-San/nbapi/setting/performance_setting"
...
func InitOptionMap() {
	...
	common.OptionMap["TrustedProxiesEnabled"] = strconv.FormatBool(common.IsTrustedProxyValidationEnabled())
	...
	common.OptionMap["HomePageBackground"] = ""
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "TrustedProxiesEnabled":
			common.SetTrustedProxyValidationEnabled(boolValue)

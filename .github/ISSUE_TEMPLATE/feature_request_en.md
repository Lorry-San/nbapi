...
- Docs: https://github.com/Lorry-San/nbapi/
- Usage questions first: https://deepwiki.com/Lorry-San/nbapi
...
- [ ] **Non-duplicate issue:** I have searched existing [Issues](https://github.com/Lorry-San/nbapi/issues?q=is%3Aissue) and confirmed there are no similar issues.
- [ ] **Read this first:** I have fully read the section above, reviewed the docs at https://github.com/Lorry-San/nbapi/ and the project README, and asked AI first, confirming this is not a usage, configuration, or integration question, and that the current version cannot meet my needs.

...
本文档提供使用宝塔面板 Docker 功能部署 NBAPI 的图文教程。

> 📖 官方文档：[宝塔面板部署](https://github.com/Lorry-San/nbapi/zh/docs/installation/deployment-methods/bt-docker-installation)
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/nbapi`
...
services:
  nbapi:
    image: ghcr.io/lorry-san/nbapi:latest
    container_name: nbapi
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
- [官方文档](https://github.com/Lorry-San/nbapi/zh/docs/installation)
- [环境变量配置](https://github.com/Lorry-San/nbapi/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://github.com/Lorry-San/nbapi/zh/docs/support/faq)
- [GitHub 仓库](https://github.com/Lorry-San/nbapi)

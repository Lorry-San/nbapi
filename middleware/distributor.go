...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.NBAPIError {
	...
	key, index, nbapiError := channel.GetNextEnabledKey()
	if nbapiError != nil {
		return nbapiError
	}
